...
import { FaGithub, FaLinkedin, FaTwitter, FaEnvelope, FaPhone, FaArrowUp } from "react-icons/fa"
    ...
    <div className="bg-[url('/assets/images/CI.png')] bg-cover bg-center bg-no-repeat bg-fixed min-h-screen w-full relative">
      ...
      <nav className="fixed top-0 left-0 w-full p-0 z-50 bg-white/1 backdrop-blur-md border-b border-white/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex space-x-6">
            ...
            <NavLink onClick={() => scrollToSection("skills")} label="Skills" />
            <NavLink onClick={() => scrollToSection("projects")} label="Projects" />
      ...
      >
        <h1 className="text-[2.4em] font-bold mb-6 text-left pl-14">
          Hi there{" "}
          <motion.span role="img" className="inline-block" aria-label="waving hand" animate={controls}>
            👋🏽
          </motion.span>
        </h1>
        <motion.h1
      ...
      {/* About Section */}
      <section id="about" className="bg-black/10 text-white px-6 py-16 md:px-20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-start justify-between gap-10">
          ...
          <div className="w-full md:w-2/3 mt-20 md:mt-40 text-center md:text-left px-2 sm:px-6">
            ...
            <p className="text-base sm:text-lg leading-relaxed mb-4 text-white">
              Hey there! I'm Njoki Mwai, a dedicated <strong>Software Developer</strong> who enjoys building strong
              and efficient backend systems that turn ideas into real products.
              <br />
              <br />I enjoy working across the stack—from responsive UIs with <strong>React and Next.js</strong> to
              robust backends with
              <span className="text-purple-400 font-semibold"> Node.js, Express, MongoDB, PostgreSQL and MySQL.</span>{" "}
              Currently learning backend with <span className="text-purple-400 font-semibold">PHP.</span>
              <br />
              <br />
              I'm skilled in <strong>Git & GitHub</strong> for collaboration and use tools like
              <strong> Vercel, Netlify, and Render</strong> for deployment.
              <br />
              <br />I love <strong>solving real-world problems</strong> with clean, scalable code and enjoy working in
              teams that push me to grow and build better.
            </p>
          </div>
      ...
      {/* Skills Section */}
      <section id="skills" className="bg-black/10 text-white px-6 py-20 md:px-20">
        <div>
          <h1 className="text-center text-white pt-20 text-3xl font-bold">PROFESSIONAL SKILLSET</h1>

          <div className="text-center mt-10">
            {skills.map((section, index) => (
              <div key={index} className="mb-9">
                <h2 className="text-3xl font-semibold text-purple-400 mb-6">{section.category}</h2>
      ...
      {/* Contact Section */}
      <section id="contact" className="bg-black/10 text-white px-6 py-16 md:px-20 mt-10 relative">
        <motion.h1
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
          ...
          <div className="w-full md:w-1/2 space-y-8">
            <div>
              <h2 className="text-3xl font-bold text-purple-400 mb-4">Feel free to reach out!</h2>
              <p className="text-lg text-white">
                Collaboration, job opportunities, or just saying hello — I'm excited to connect with you!
              </p>
            </div>
            {/* Contact Links */}
            <div className="space-y-4 text-gray-200">
              <ContactLink href="mailto:mercyneemam@gmail.com" icon={<FaEnvelope />} label="mercyneemam@gmail.com" />
              <ContactLink href="https://github.com/mercy-mwai" icon={<FaGithub />} label="Njoki Mwai" newTab />
              <ContactLink
                ...
                newTab
              />
              <ContactLink href="https://x.com/NjokiiMwai" icon={<FaTwitter />} label="Njoki Mwai" newTab />
              <ContactLink href="tel:+254703574893" icon={<FaPhone />} label="+254703574893" />
            </div>
          </div>
          {/* Right: Contact Form */}
          <div className="w-full md:w-1/2 space-y-8">
            <h2 className="text-3xl font-bold text-purple-400 mb-4">Send me a message</h2>
        ...
        {/* Footer */}
        <footer className="w-full text-white p-3 bg-white/3 backdrop-blur-md border-t border-white/20 mt-10">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            {/* Left content */}
            <p className="text-center md:text-left text-sm">© 2025 Njoki. All rights reserved.</p>
            {/* Center social icons */}
            <div className="flex space-x-4">
              ...
              <a href="mailto:mercyneemam@gmail.com" className="hover:text-purple-400 transition duration-300">
                <FaEnvelope size={22} />
              </a>
              <button onClick={scrollToTop} className="hover:text-purple-400 transition duration-300">
                <FaArrowUp size={22} />
              </button>
            </div>
            {/* Right content */}
            <p className="text-center md:text-right text-sm">Privacy & Copyright Policies</p>
          </div>
        </footer>
      </section>
    </div>
